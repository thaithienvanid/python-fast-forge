...
This project uses Atlas for schema management:
- **Generate migration**: `make migrate-create m="description"`
- **Apply migrations**: `make migrate`
- **Check status**: `make migrate-status`
- **Rollback**: `make migrate-downgrade`

Migration files:
- Format: `YYYYMMDDHHMMSS_slug.sql`
- Example: `20251111120000_add_user_avatar.sql`
- Pure SQL generated from SQLAlchemy models
- See [Database Migrations Guide](./docs/how-to/database-migrations.md)
