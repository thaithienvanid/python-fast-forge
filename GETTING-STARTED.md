...
# Install Atlas CLI (migration tool)
curl -sSf https://atlasgo.sh | sh
# or on macOS: brew install ariga/tap/atlas
...
**Migration system:**
- Atlas generates migrations from SQLAlchemy models
- Uses `load_models.py` to inspect your models
...
**Atlas workflow:**
1. Modify your SQLAlchemy models in `src/domain/models/`
2. Add new models to `load_models.py`
3. Run `make migrate-create m="description"`
...
- **[Database Migrations](./docs/how-to/database-migrations.md)** - Managing schema changes
